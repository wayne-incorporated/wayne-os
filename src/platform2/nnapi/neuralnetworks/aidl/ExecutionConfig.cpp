...
const char* ExecutionConfig::descriptor = "android.hardware.neuralnetworks.ExecutionConfig";
...
binder_status_t ExecutionConfig::readFromParcel(const AParcel* _aidl_parcel) {
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &loopTimeoutDurationNs);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &extensionNameToPrefix);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
...
binder_status_t ExecutionConfig::writeToParcel(AParcel* _aidl_parcel) const {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, loopTimeoutDurationNs);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, executionHints);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, extensionNameToPrefix);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
