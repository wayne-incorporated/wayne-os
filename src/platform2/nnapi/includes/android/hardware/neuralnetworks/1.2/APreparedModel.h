#ifndef HIDL_GENERATED_ANDROID_HARDWARE_NEURALNETWORKS_V1_2_APREPAREDMODEL_H
#define HIDL_GENERATED_ANDROID_HARDWARE_NEURALNETWORKS_V1_2_APREPAREDMODEL_H
...
class APreparedModel
    : public ::android::hardware::neuralnetworks::V1_2::IPreparedModel {
 public:
  typedef ::android::hardware::neuralnetworks::V1_2::IPreparedModel Pure;
  APreparedModel(
      const ::android::sp<
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_NEURALNETWORKS_V1_2_APREPAREDMODEL_H
