// This file is copied directly, and unmodified from
// AOSP: /hardware/interfaces/common/support/include/aidlcommonsupport/
 ...
 * objects.
 */
aidl::android::hardware::common::NativeHandle makeToAidl(
 ...
 * internally.
 */
aidl::android::hardware::common::NativeHandle dupToAidl(
    const native_handle_t* handle);
