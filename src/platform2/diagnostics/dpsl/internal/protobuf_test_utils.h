...
#ifndef DIAGNOSTICS_DPSL_INTERNAL_PROTOBUF_TEST_UTILS_H_
#define DIAGNOSTICS_DPSL_INTERNAL_PROTOBUF_TEST_UTILS_H_
...
#endif  // DIAGNOSTICS_DPSL_INTERNAL_PROTOBUF_TEST_UTILS_H_
