...
#ifndef SECANOMALYD_TEXT_FILE_READER_H_
#define SECANOMALYD_TEXT_FILE_READER_H_
...
class TextFileReader {
 ...
 private:
  ...
  FRIEND_TEST(TextFileReaderTest, InvalidFileTest);
  FRIEND_TEST(TextFileReaderTest, OpenFileTest);
  FRIEND_TEST(TextFileReaderTest, ReopenFileOnMoveTest);
  FRIEND_TEST(TextFileReaderConcurrentTest, ReadAppendedTextTest);
  FRIEND_TEST(TextFileReaderConcurrentTest, ReadLineLongerThanBufferTest);
  FRIEND_TEST(TextFileReaderConcurrentTest, OpenFileRetryTest);
  FRIEND_TEST(TextFileReaderConcurrentTest, OpenFileRetryExceededTest);
  FRIEND_TEST(TextFileReaderConcurrentTest, HandleFileMoveTest);
};

}  // namespace secanomalyd

#endif  // SECANOMALYD_TEXT_FILE_READER_H_
