...
#ifndef ARC_KEYMINT_CONTEXT_CRYPTO_OPERATION_H_
#define ARC_KEYMINT_CONTEXT_CRYPTO_OPERATION_H_
...
// TODO(b/274723555): Confirm from ChromeOS security about newer values being
// supported for Algorithms, Digest, etc.
// Comprehensive list of cryptographic operations supported for ChromeOS keys.
enum class OperationType {
  kSign,
  kUnsupported,
};

// Comprehensive list of algorithms supported for ChromeOS keys.
enum class Algorithm {
  kRsa,
  kUnsupported,
};

// Comprehensive list of digests supported for ChromeOS keys.
enum class Digest {
  kMd5,
  kSha1,
  kSha256,
...
// Comprehensive list of paddings supported for ChromeOS keys.
enum class Padding {
...
// Comprehensive list of block modes supported for ChromeOS keys.
...
#endif  // ARC_KEYMINT_CONTEXT_CRYPTO_OPERATION_H_
