...
#ifndef ARC_KEYMINT_CONTEXT_CHAPS_CLIENT_H_
#define ARC_KEYMINT_CONTEXT_CHAPS_CLIENT_H_
...
class ChapsClient {
 public:
  ...
  // Returns the ARC KeyMint AES-256 encryption key material. If the key does
 ...
 private:
  ...
  // Generates the ARC KeyMint AES-256 encryption key material and returns its
  ...
  std::unique_ptr<ScopedSession> session_;
...
#endif  // ARC_KEYMINT_CONTEXT_CHAPS_CLIENT_H_
